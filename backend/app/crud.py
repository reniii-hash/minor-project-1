...
def get_all_users(db: Session):                    #return list of user
...
# Ensure the fixed admin exists when the application starts
def create_fixed_admin_if_not_exists(db: Session):
    fixed_admin_username = "admins" 
    fixed_admin_password = "adminspassword"  
    fixed_admin_email = "admins@example.com"
